 ...
 * renvoyée par cette fonction ne ferme pas le flux passé en
 * argument). */
...
/* Vide le `pseudo´ buffer qui nous sert à écrire bit à bit. */
int bfflush (BFILE *f);
 ...
 * valeur retournée est 1, 0 respectivement en fonction de la
 * réussite ou de l'echec de l'opération sur le fichier. */
