...
list_new (void *data)
{
	...
	if ((e = LIST (pcalloc (sizeof (List_t)))))
		e->data = data;
...
int
list_insert_sorted_e (List_t **list, CompareCB_t func, int way, List_t *e)
{
	int c;
	List_t *l, *p;
...
int
list_insert_sorted (List_t **list, CompareCB_t func, int way, void *data)
{
	List_t *new = list_new (data);
...
int
list_find (List_t *list, const void *data, CompareCB_t func, List_t **l)
{
	int i = 0;
...
void
list_foreach (List_t *list, ForeachCB_t func, void *udata)
{
	while (list)
	{
...
slist_new (void *data)
{
	...
	if ((e = SLIST (pcalloc (sizeof (SList_t)))))
		e->data = data;
...
int
slist_insert_sorted_e (SList_t **list, CompareCB_t func, int way, SList_t *e)
{
	int c;
	SList_t *l, *p;
...
int
slist_insert_sorted (SList_t **list, CompareCB_t func, int way, void *data)
{
	SList_t *new = slist_new (data);
...
int
slist_find (SList_t *list, const void *data, CompareCB_t func, SList_t **l)
{
	int i = 0;
...
void
slist_foreach (SList_t *list, ForeachCB_t func, void *udata)
{
	while (list)
	{
		func (list->data, udata);
