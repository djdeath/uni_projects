...
int list_find (List_t *list, const void *data, CompareCB_t func, List_t **l);
int list_find_d (List_t *list, const void *data, List_t **l);

void list_foreach (List_t *list, ForeachCB_t func, void *udata);
...
int list_insert_sorted (List_t **list, CompareCB_t func, int way, void *data);
...
int list_insert_sorted_e (List_t **list, CompareCB_t func, int way, List_t *e);
...
int slist_find (SList_t *list, const void *data, CompareCB_t func, SList_t **l);
int slist_find_d (SList_t *list, const void *data, SList_t **l);

void slist_foreach (SList_t *list, ForeachCB_t func, void *udata);
...
int slist_insert_sorted_e (SList_t **list, CompareCB_t func, int way, SList_t *e);
...
int slist_insert_sorted (SList_t **list, CompareCB_t func, int way, void *data);
