...
#define EHASH_FUNC  130 /* Fonctionnalité non implémentée. */
 ...
 * l'insertion réussit, un code d'erreur sinon. */
int hash_table_insert (HashTable_t *ht, const void *key, void *data);

/* Retrait d'un élément dans une table de hachage. Retourne 0 si
 * l'insertion réussit, un code d'erreur sinon. */
